...
def sample(model, n_samples, batch_size=64):
    ...
    start_input = torch.full(size=(1,batch_size), fill_value=33, dtype=torch.int64) #Start Symbol
    seed_tensor = torch.full(size=(1,batch_size), fill_value=81, dtype=torch.int64) #Seed M:6/8
